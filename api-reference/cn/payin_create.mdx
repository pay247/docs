...
| pay_method         | 否  |string | [支付方式](/api-reference/en/common/#dict) ，如果为空，自动选择可用的支付方式          |
...
| payer_bank_code | 可选  |string | 【依据相关渠道】 付款人银行代码   [银行列表](/api-reference/cn/banks/bank_ph)             |
